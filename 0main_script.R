...
#Function: Finalreport2plink, QC, ancestry, 1000G merge
...
#############################################################################
### Step 0: Setup
# Change with "your/finalreport/path"
setwd("/omics/groups/OE0136/internal/projects/MS_Francesco/test") # delete after finishing
...
system ("git clone https://github.com/Biomuratg/Update/scripts") # will be updated
